...
export default function ContactUs() {
  ...
  return (
      <main className="container mx-auto relative font-poppins flex items-center w-screen pt-28 px-6">
        <div className="h-full w-full flex flex-col items-center justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-50">
            ...
            <div className="flex flex-col items-center justify-center">
              <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200 rounded-xl shadow-xl p-12">
                <CardContent className="flex flex-col items-center justify-center h-full">
                  <div className="mb-6">
                    ...
                    <h2 className="text-xl font-semibold text-center mb-2 text-green-600 pt-4">Contáctanos por WhatsApp</h2>
