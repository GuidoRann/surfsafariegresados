...
export default function FAQSection() {
  return (
    <div className=" py-20 px-6 md:px-20 bg-surf-red text-white">
      <div className="text-center mb-12">
        <h2 className="text-4xl font-poppins font-bold mb-4">Preguntas frecuentes</h2>
        <div className='w-20 h-1 bg-surf-white mx-auto mb-6'></div>
      </div>
      ...
      <div className="mt-10">
        ...
        <Accordion type="single" collapsible className="border border-black rounded-md">
          <AccordionItem value="item-1" className="border-b border-black">
            <AccordionTrigger className="px-6 py-4 hover:bg-surf-yellow data-[state=open]:bg-surf-yellow text-xl transition-colors text-black duration-400">
